...
<template>
	<div>
		...
		<el-row :gutter="15" class="mb10">
			...
			<el-col :span="1.5">
				<el-button type="danger" :disabled="multiple" v-hasPermi="['inventoryplan:delete']" plain icon="delete"
					@click="handleDelete">
					{{ $t('btn.delete') }}
				</el-button>
			</el-col>
		...
		<el-table @row-dblclick="PlanDrugdatalist" :data="dataList" v-loading="loading" ref="table" border
			...
			<el-table-column label="操作" width="160">
				<template #default="scope">
					...
					<el-button type="success" size="small" icon="edit" title="编辑" v-hasPermi="['inventoryplan:edit']"
						@click="handleUpdate(scope.row)"></el-button>
					<el-button type="danger" size="small" icon="delete" title="删除" v-hasPermi="['inventoryplan:delete']"
		...
		<el-table :data="PlanDrugsdataList" v-loading="PlanDrugsloading" ref="PlanDrugstable" border
			...
			<el-table-column prop="drugQuantity" label="数量" align="center" :show-overflow-tooltip="true"
				...
				<template #default="{ row }">
					<el-input v-model="row.drugQuantity" size="small" @blur="PlanDrugshandleDrugQuantityChange(row)" />
				</template>
			</el-table-column>
			<el-table-column prop="remarks" label="备注" align="center" :show-overflow-tooltip="true"
			...
			<el-table-column label="操作" width="160">
				<template #default="scope">
					...
					<el-button type="success" size="small" icon="edit" title="编辑"
						v-hasPermi="['inventoryplandrugs:edit']" @click="PlanDrugshandleUpdate(scope.row)"></el-button>
