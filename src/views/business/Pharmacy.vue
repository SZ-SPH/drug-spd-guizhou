  ...
  <div>
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent>
      <el-form-item label="药房名称" prop="pharmacyName">
        <el-input v-model="queryParams.pharmacyName" placeholder="请输入药房名称" />
      </el-form-item>
    ...
    <el-row :gutter="15" class="mb10">
      <el-col :span="1.5">
        <el-button type="primary" v-hasPermi="['pharmacy:add']" plain icon="plus" @click="handleAdd">
          {{ $t('btn.add') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
      ...
      <el-col :span="1.5">
        <el-button type="danger" v-hasPermi="['pharmacy:delete']" plain icon="delete" @click="handleClear">
          {{ $t('btn.clean') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-dropdown trigger="click" v-hasPermi="['pharmacy:import']">
      ...
      <el-col :span="1.5">
        <el-button type="warning" plain icon="download" @click="handleExport" v-hasPermi="['pharmacy:export']">
          {{ $t('btn.export') }}
        </el-button>
      </el-col>
    ...
    <el-dialog :title="title" :lock-scroll="false" v-model="open" >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="药房名称" prop="pharmacyName">
              <el-input v-model="form.pharmacyName" placeholder="请输入药房名称" />
            </el-form-item>
          </el-col>
  ...
  proxy.$refs["formRef"].validate((valid) => {
    if (valid) {
      ...
      if (form.value.id != undefined && opertype.value === 2) {
        updatePharmacy(form.value).then((res) => {
...
function handleExport() {
  proxy
    ...
    .then(async () => {
      await proxy.downFile('/business/Pharmacy/export', { ...queryParams })
    })
}
