...
const fetchData = async (code) => {
  try {
    const response = await axios.get('http://119.145.169.162:50099/Mtaobo/codedetail', {
      params: { codes: code }
    });
...
const getAllMixCodedataList = async (code) => {
  try {
    ...
    const response = await axios.get('http://119.145.169.162:50099/Mtaobo/AllMIXcode', {
      params: { codes: code }
    });
