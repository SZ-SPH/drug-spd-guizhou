<template>
  <el-form class="mt10" ref="formRef" :model="form" label-width="100px" :rules="rules">
    <el-row>
      <el-col :lg="6">
        <el-form-item label="发送病患" prop="fromName">
          <el-select v-model="form.fromName" placeholder="请选择发送病患">
      ...
      <el-col :lg="6">
        <el-form-item label="选择模板" prop="emailTpl">
          <el-select v-model="form.emailTpl" placeholder="病患模板" @change="handleSelectTpl" clearable>
    ...
    <el-form-item label="接收人" prop="toEmails">
      ...
      <el-button v-else class="button-new-tag" size="small" icon="plus" text @click="showInput">收件人病患</el-button>
    </el-form-item>
    <el-form-item label="病患主题" prop="subject">
      <el-input v-model="form.subject"></el-input>
    </el-form-item>

    <el-form-item label="病患内容" prop="htmlContent">
    ...
    <el-form-item>
      <el-button type="primary" icon="upload" @click="formSubmit">发送病患</el-button>
    </el-form-item>
  </el-form>
</template>
...
const data = reactive({
  ...
  rules: {
    fromName: [{ required: true, message: '发送病患不能为空', trigger: 'blur' }],
